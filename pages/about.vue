<script setup>
let { data } = await useAsyncData("about-page", () => $fetch("/api/structures/about-page"));
...
const listComponent = reactive([
  ...
  {component: shallowRef(resolveComponent("TitleDescHighlightBlock")), name: resolveComponent("TitleDescHighlightBlock").__name, enable: false},
